                ...
                for newTime in replaceTime:
                    ...
                    for line in open("template.txt", encoding="utf-8"):
                        ...
                        if(line.startswith("#")):
                            ...
                            newLine = newInstance +"|"+ tmpTime[0] + "|" + splitWords[2] + "|" + tmpTime[1] + "|" + splitWords[
                                4] + "|" + newAttribute +"|"+ splitWords[6] + "|" + splitWords[7] + "|" + splitWords[8] + "|" + \
                                      splitWords[9] + "|" + splitWords[10]
                            ...
                            newLine = newInstance + "|" + splitWords[1] + "|" + tmpTime[0] + "|" + splitWords[3] + "|" + \
                                      tmpTime[
                                          1] + "|" + splitWords[5] + "|" + newAttribute + "|" + splitWords[7] + "|" + \
                                      splitWords[8] + "|" + \
                                      splitWords[9]
