                ...
                for newTime in replaceTime:
                    ...
                    for line in open("template.txt", encoding="utf-8"):
                        ...
                        if(line.startswith("#")):
                            ...
                            splitWords = line.split("|")
                            newLine = newInstance + "|" + newAttribute + "|" + tmpTime[0] + "|" + splitWords[3] + "|" + \
                                      tmpTime[
                                          1] + "|" + splitWords[5] + "|" + splitWords[6] + "|" + splitWords[7] + "|" + \
                                      splitWords[8]
                        elif(line.startswith("@")):
                            splitWords = line.split("|")
                            newLine = newInstance + "|" + newAttribute + "|" + tmpTime[0] + "|" + splitWords[3] + "|" + \
                            ...
                            splitWords = line.split("|")
                            newLine=newInstance+"|"+tmpTime[0]+"|"+ splitWords[2]+"|"+ splitWords[3]+tmpTime[1]+"|"+newAttribute+ \
                                "|"+splitWords[6] + "|" + splitWords[7] + "|" + splitWords[8] + "|" + splitWords[9]
                        else:
                            continue
